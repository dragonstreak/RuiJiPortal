define(function (require, exports, module) {
    ...
    Paging.prototype = {
        _init: function () {
            ...
            this._left = jQuery('<a class="sm-paging-first" href="javascript:void(0);"><span class="sm-paging-left"></span><span class="sm-paging-left"></span></a>');
            ...
            this._right = jQuery('<a class="sm-paging-last" href="javascript:void(0);"><span class="sm-paging-right"></span><span class="sm-paging-right"></span></a>');
        ...
        _drawNumbers: function () {
            ...
            for (var i = 1; i <= this._total; i++) {
                aList[aList.length] = this._printf('<a href="javascript:void(0);" class="{$cls}">{$i}</a>',
                {
