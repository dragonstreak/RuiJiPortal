    ...
    public class LoginHandler : IHttpAsyncHandler
    {
        ...
        private void EndProcess(LoginAsyncResult result)
        {
            ...
            {                
                ...
                httpContext.Response.Redirect("~/RuiJiInternal/Article", false);
                httpContext.ApplicationInstance.CompleteRequest();
            }
            else
            {
                httpContext.Response.Redirect(string.Format("~/RuiJiInternal/Login?loginErrorMsg={0}", result.ErrorMessage), false);
                httpContext.ApplicationInstance.CompleteRequest();
            }
